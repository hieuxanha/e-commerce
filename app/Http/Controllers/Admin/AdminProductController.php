...
class AdminProductController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.QL_sanpham', compact('products', 'brands', 'categories'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.sanpham.them')->with('ok', 'Đã lưu sản phẩm!');
    ...
    public function edit($id)
    {
        ...
        return view('admin.edit_sanpham', compact('product', 'brands', 'categories'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.danhsachsanpham')->with('success', 'Cập nhật sản phẩm thành công!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.danhsachsanpham')->with('success', 'Xóa sản phẩm thành công!');
    }
}

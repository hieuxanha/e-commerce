...
<body>
    <div class="app">
        ...
        <main>
            <!-- Topbar -->
            <div class="top">
                <form class="top-search" action="{{ route('admin.brands.index') }}" method="GET" role="search">
                    <input
                        type="text"
                        name="q"
            ...
            <div class="container-fluid py-3">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <a class="btn btn-outline-secondary btn-sm" href="{{ route('admin.brands.index') }}">
                        Làm mới danh sách
                    </a>
                </div>
    ...
    <script>
        (function() {
            ...
            const updateUrlTpl = "{{ route('admin.brands.update', ['brand' => '__ID__']) }}";

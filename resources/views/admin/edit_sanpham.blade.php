    ...
    <div class="app">
        ...
        <main>
            ...
            <div class="container my-4">
                ...
                <form action="{{ route('admin.sanpham.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row g-3">
                        <div class="col-md-8">
                            ...
                            <div class="mt-3">
                                ...
                                <a href="{{ route('admin.danhsachsanpham') }}" class="btn btn-secondary">Hủy</a>
                            </div>
                        </div>

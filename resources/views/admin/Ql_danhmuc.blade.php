...
<body>
    <div class="app">
        ...
        <main>
            <!-- Topbar -->
            <div class="top">
                <form class="top-search" action="{{ route('admin.categories.index') }}" method="GET" role="search">
            ...
            <div class="container-fluid py-3">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <a class="btn btn-outline-secondary btn-sm" href="{{ route('admin.categories.index') }}">Làm mới danh sách</a>
                </div>
                                        ...
                                        <div class="modal fade" id="editCategoryModal{{ $c->id }}" tabindex="-1" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ route('admin.categories.update', $c) }}" method="POST">
                                                        @csrf
                                                        @method('PUT')
